...
function getIniCabecera(){
                    ...
                    <ul>
                        ...
                        <li class='settings'><a href='#'><i class='fa fa-cog'></i></a>
                            ...
                            -->
                                    <dl class='my-account'>
                                    <dt>Mi Cuenta</dt>
                                    <dd><a href='login.php'>Iniciar Sesión</a></dd>
                                    <dd><a href='#'>Registrarse</a></dd>
                                    <dd><a href='#'>¿Olvidaste tu Contraseña?</a></dd>
                                    </dl>
                            <!--
                                <dl class='language'>
                                    <dt>Language</dt>
    ...
    function getCuenta(){
        ...
        if (!isset($_SESSION['id'])){
            ...
            $v_cuenta = "<dl class='my-account'>
                        <dt>Mi Cuenta</dt>
                        <dd><a href='login.php'>Inicias Sesión</a></dd>
                        <dd><a href='#'>Registrarse</a></dd>
                        <dd><a href='#'>¿Olvidaste tu Contraseña?</a></dd>
                        </dl>";
            ...
            $v_cuenta = "<dl class='my-account'>
            <dt>".$_SESSION['usuario']."</dt>
            <dd><a href='login.php'>Datos Personales</a></dd>
            <dd><a href='#'>Historial de pedidos</a></dd>
            <dd><a href='#'>Cerrar Sesión</a></dd>
            </dl>";
        }
        return $v_cuenta;
    }
